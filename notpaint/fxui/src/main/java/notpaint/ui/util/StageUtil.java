...
public class StageUtil {
    ...
    /**
     * Will call the callback with GameInfoPersistence as soon as stage is set for
     * Node.
     *
     * @param node     Node to get stage reference from
     * @param callback Method to call when stage is set
     */
    public static void onGameInfoPersistenceLoaded(Node node,
            Consumer<GameInfoPersistence> callback) {
